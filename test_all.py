...
def run_python_tests():
    ...
    result = subprocess.run(["python3", "-m", "unittest", "tests/test_python.py"], capture_output=True, text=True)
    print(result.stdout)
